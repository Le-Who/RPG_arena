...
export type Settings = { keysMasked: string[]; keysCount: number; envKeysCount: number; useLiveAI: boolean; routingProfile: string; narrationModel: string; customActionModel: string; compactionModel: string; fastTaskModel: string; keysSharedProject: boolean; dailyEmbeddingLimit: number; dailyFlashLimit: number; dailyLiteLimit: number; enforceLimits: boolean; embeddingsEnabled: boolean; embeddingModel: string; embeddingDims: number; semanticExtractionEnabled: boolean };
